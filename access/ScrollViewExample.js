 ...
 * @format
 */
// const { Text, StyleSheet, View, ScrollView } = require('react-native');
...
function ScrollViewAccessibleExample() {
...
export default ({
    title: 'ScrollView',
    name: 'ScrollViewAccessible',
    description:
        'Accessiblity about Button',
    render: () => <ScrollViewAccessibleExample />,
